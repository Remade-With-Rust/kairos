...
#define traceQUEUE_CREATE( pxNewQueue )                                kairos_trace_obj_u( "QUEUE_CREATE", 'q', ( const void * ) ( pxNewQueue ), ( unsigned long ) ( pxNewQueue )->uxLength )
...
#define traceSTREAM_BUFFER_CREATE( pxStreamBuffer, xIsMessageBuffer )  kairos_trace_obj_u( "STREAM_BUFFER_CREATE", 's', ( const void * ) ( pxStreamBuffer ), ( unsigned long ) ( xIsMessageBuffer ) )
