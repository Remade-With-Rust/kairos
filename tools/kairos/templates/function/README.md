...
[![crates.io](https://img.shields.io/crates/v/__NAME__.svg)](https://crates.io/crates/__NAME__)
[![docs.rs](https://docs.rs/__NAME__/badge.svg)](https://docs.rs/__NAME__)
...
- This package's plan: [docs/plans/__NAME__.md](docs/plans/__NAME__.md)
...
```text
crates/__NAME__          facade: re-exports + prelude; the crate you depend on
crates/__NAME__-core     no_std (+ alloc); forbid(unsafe); types, traits, algorithms
...
cargo check -p __NAME__-core --no-default-features \
  --target thumbv7em-none-eabihf                         # Cortex-M4F class, no alloc
cargo check -p __NAME__-core --no-default-features --features alloc \
...
**Tier** __TIER__ · **Audited** __DATE__ (survey) · **v1.0.0 gates** 6/16 · [Full checklist](docs/plans/use-protection-please.md)
