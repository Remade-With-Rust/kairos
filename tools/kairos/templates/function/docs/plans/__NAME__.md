# __NAME__ — package plan

**One sentence:** __DESCRIPTION__
...
Written __DATE__. Status: **scaffold** — the crate layout, the feature ladder,
...
| Date | Decision |
|---|---|
| __DATE__ | Stamped from the Kairos template; obeys the family plan. |
